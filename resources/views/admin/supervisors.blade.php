    ...
    <div class="panel">
        ...
        <form method="POST" action="{{ route('admin.supervisors.store') }}">
            ...
            <div class="panel-body">
                <div class="field" style="margin-bottom:.8rem"><label>Full name</label><input type="text" name="name" value="{{ old('name') }}" required></div>
                <div class="field" style="margin-bottom:.8rem"><label>Role</label>
                    <select name="role">
                ...
                <div class="field" style="margin-bottom:.8rem" data-show-when="role=EDM"><label>Division</label>
                ...
                <div class="field" style="margin-bottom:.8rem" data-show-when="role=DEM"><label>District</label>
                ...
                <div class="field" style="margin-bottom:.8rem" data-show-when="role=PEA"><label>Zone</label>
                ...
                <div class="field" style="margin-bottom:.8rem"><label>Email</label><input type="email" name="email" value="{{ old('email') }}"></div>
                <div class="field" style="margin-bottom:.8rem"><label>Mobile number</label><input type="tel" name="phone" value="{{ old('phone') }}"></div>
